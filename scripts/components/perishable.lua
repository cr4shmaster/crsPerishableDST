...
local function Update(inst, dt)
    if inst.components.perishable then
		...
		if owner then
  if owner:HasTag("icypouch") then -- Handle the Icy Magical Pouch separately
				modifier = ICEPOUCH_PERISH_MULT
			elseif owner:HasTag("freezer") then -- Handle the Freezer separately
				modifier = chilltime
